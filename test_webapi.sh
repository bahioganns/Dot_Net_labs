# Create User
curl "http://localhost:5000/api/user" -X POST -H "Content-Type: application/json" --data '{"Email":"q1we@rty.ru","Description":"qwerty"}'

# Create Bad User
curl "http://localhost:5000/api/user" -X POST -H "Content-Type: application/json" --data '{"Email":"@r.u","Description":"qwerty"}'
...
# Update User Data
curl "http://localhost:5000/api/user/1" -X PUT -H "Content-Type: application/json" --data '{"Email":"asd@aww.ru","Description":"123456"}'
